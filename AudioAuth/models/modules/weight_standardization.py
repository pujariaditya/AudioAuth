"""Weight standardization module for convolutional layers.

Implements the weight standardization normalization technique, which
standardizes the weights of convolutional layers by their mean and variance
